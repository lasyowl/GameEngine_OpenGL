...
enum SceneState { SCENE_CLOSING, SCENE_GREETING, SCENE_LOAD_OBJE, SCENE_LOAD_TERE, SCENE_TERE, SCENE_OBJE };

enum LoadState { LOADING_GUI, LOADING_LIGHT, LOADING_MESH_TERRAIN,
	LOADING_TERRAIN, LOADING_TEXTURE_TERRAIN, LOADING_RENDERER_TERRAIN, LOADING_EDITOR_TERRAIN, LOADING_RENDERER_POINT, LOADING_RENDERER_SPHERE, 
	LOADING_RENDERER_WATER, LOADING_RENDERER_ANIMATED, LOADING_RENDERER_STATIC, LOADING_CONTROLLER_ANIMATED,
	LOADING_CONTROLLER_STATIC, LOADING_MODEL_TRANSFORM_LOADER, LOADING_GLUT_MENU, LOADING_CAMERA, LOADING_FINISHED };
